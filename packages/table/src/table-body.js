...
export default {
  ...
  methods: {
    ...
    handleCellMouseEnter(event, row) {
      ...
      if ((rangeWidth + padding > cellChild.offsetWidth || cellChild.scrollWidth > cellChild.offsetWidth) && this.$refs.tooltip || (cellChild.scrollHeight > cellChild.offsetHeight && this.$refs.tooltip)) {
